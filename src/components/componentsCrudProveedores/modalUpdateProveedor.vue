    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          Actualizando proveedor: {{proveedor.nombre}}
        ...
        <div class="modal-body" v-if="isLoadingUpdate == false">
                <form >
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="proveedor.nombre" placeholder="Nombre del proveedor" id="nombre" name="nombre"
                              :class="{ 'is-invalid': submitted && $v.proveedor.nombre.$error }"
                            />
                            <div v-if="submitted && !$v.proveedor.nombre.required" class="invalid-feedback">Nombre de la categoria  es requerido</div>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Descripción del proveedor:</label>
                            <input type="text" class="form-control" v-model="proveedor.descripcion" placeholder="Nombre del proveedor" id="descripcion" name="descripcion"
                            :class="{ 'is-invalid': submitted && $v.proveedor.descripcion.$error }"
                            />
                            <div v-if="submitted && !$v.proveedor.descripcion.required" class="invalid-feedback">La descripcion del proveedor   es requerido</div>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail1">Teléfono proveedor:</label>
                            <input type="text" class="form-control" v-model="proveedor.telefono" placeholder="Teléfono del proveedor"
                            name="telefono"
                            id="telefono"
                            :class="{ 'is-invalid': submitted && $v.proveedor.telefono.$error }"
                            />
                            <div v-if="submitted && !$v.proveedor.telefono.required" class="invalid-feedback">El teléfono del proveedor  es requerido</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <img width="50%" :src="proveedor.imagen" />
...
export default {
  ...
  methods: {
    ...
    let data =  new FormData();
        ...
        data.append('descripcion',this.proveedor.descripcion);
        data.append('telefono',this.proveedor.telefono);
        data.append('imagen',this.dataImage);

        console.log(this.dataImage);
        apiPrimal.updateProveedor(data,this.proveedor.id).then(res =>{
    ...
    renderingImages(file){
        ...
        reader.onload = (e) =>{
            ...
            this.proveedor.imagen = e.target.result;
        }
